    ...
    val animal6 = """
        {
            ...
            "classification": "Mammifero",
            "averageLife": "24",
            "animalDescription": "Lo stambecco delle Alpi (Capra ibex L. 1758), anche noto come stambecco alpino, bouquetin, o semplicemente stambecco, è una specie di capra selvatica diffusa sulle montagne dell'Arco alpino. È una specie sessualmente dimorfica: i maschi sono più grandi e presentano corna più lunghe e ricurve rispetto alle femmine. Il colore del suo mantello è tipicamente grigio brunastro. Gli stambecchi alpini tendono a vivere su terreni ripidi e accidentati vicino al limite delle nevicate. Sono animali socievoli, sebbene maschi e femmine adulti rimangono separati per la maggior parte dell'anno, riunendosi solo per accoppiarsi, raggruppandosi in quattro gruppi distinti; gruppi di maschi adulti, gruppi di femmine con cuccioli, gruppi di giovani e gruppi di sesso misto.",
            "threats": " La specie mostra sofferenza di fronte al progressivo mutamento del clima, che sull’arco alpino si presenta sempre più torrido. Le prospettive per il futuro dello stambecco non sono affatto rosee, addirittura si parla di  rischio di estinzione. Proprio per questo problema si sta osservando la  tragica migrazione verso quote maggiori alla ricerca di nuovi habitat  idonei alla propria sopravvivenza. Salendo in quota lo stambecco incontrerà crescenti difficoltà nel reperire cibo in quantità e qualità idonee. L’anticipo della primavera possa comportare una riduzione dell’erba fresca, essenziale alle femmine nel periodo di svezzamento e allattamento dei piccoli, ovvero tra giugno e luglio. Con uno scioglimento anticipato e rapido delle nevi, a giugno l’erba è già in fase di invecchiamento, ricca di fibre e povera di proteine.  La carenza di nutrienti apportati dal latte materno comporta ovviamente una riduzione nelle possibilità di sopravvivenza dei nuovi nati. Inoltre, l’anticipo della primavera può comportare una riduzione dell’erba fresca, essenziale alle femmine nel periodo di svezzamento e allattamento dei piccoli, ovvero tra giugno e luglio. Con uno scioglimento anticipato e rapido delle nevi, a giugno l’erba è già in fase di invecchiamento, ricca di fibre e povera di proteine. La carenza di nutrienti apportati dal latte materno comporta ovviamente una riduzione nelle possibilità di sopravvivenza dei nuovi nati. ",
    ...
    val animal8 = """
        {
            ...
            "classification": "Mammifero",
            "averageLife": "8 - 10",
            "animalDescription": "Il saola (Pseudoryx nghetinhensis) o bue Vu Qang, uno dei mammiferi più rari del mondo, è un bovide che abita in una regione molto ristretta tra la Riserva naturale di Vu Qang e il Laos, presso il confine con il Vietnam. Il saola divenne noto alla comunità scientifica solo nel maggio del 1992, a seguito del ritrovamento in un villaggio sui monti annamiti in Vietnam di alcune paia di corna appartenenti ad un animale a quel tempo ignoto. L'analisi cromosomica ha permesso di stabilire che il saola appartiene ad un nuovo genere di ruminanti, imparentato con la mucca, il kudu, l'eland e l'anoa, e situato nella sottofamiglia Bovinae.",
            "threats": "Questa specie sta inesorabilmente scivolando verso l'estinzione a causa della pressione della caccia intensiva e della scarsa gestione delle arre protette. Intanto lo sviluppo umano sta invadendo le foreste e l'habitat della Saola, ma secondo l'Swg «La maggiore minaccia proviene dalla caccia illegale». Questi splendidi animali a quanto pare vengono catturati con lacci d'acciaio piazzati dai bracconieri per catturare altri animali, come i cervi Sambar (Rusa unicolor ) e Muntjac  (Muntiacus reevesi ) e gli zibetti, in gran parte destinati al lucroso commercio di fauna selvatica destinato alla medicina tradizionale cinese ed ai ristoranti ed ai mercati di selvaggina vietnamiti e del Laos.",
            "whatYouCanDo": "Un nuovo progetto guidato dal WWF “Salvare il Saola dall’estinzione” e finanziato dalla UE lavora su un nuovo metodo di ricerca del Saola che impiega campioni di acqua dove sono presenti DNA ambientali.",
    ...
    val animal9 = """
        {
            ...
            "classification": "Mammifero",
            "averageLife": "80",
            "animalDescription": "La balenottera comune è un animale pelagico, vive cioè prevalentemente in mare aperto lontano dalla costa. In Italia normalmente viene osservata nei mari con profondità superiore ai 2.000 m. Ha una colorazione grigio ardesia sul dorso, bianca sul ventre e presenta una caratteristica colorazione asimmetrica della parte anteriore: la mascella destra chiara e la sinistra scura, utile per distinguere i differenti individui.",
            "threats": "L’attività di caccia condotta nello stretto di Gibilterra nella prima metà del XIX secolo ha portato ad una riduzione significativa della popolazione di balenottere comuni nel Mediterraneo.Tuttavia per le balenottere comuni nel Mediterraneo sono le collisioni con le navi la principale causa di morte antropica, soprattutto dove il traffico marittimo è più intenso. Inoltre a causa del loro caratteristico metodo di alimentazione, possono catturare insieme al krill, grandi quantità di microplastiche che rimangono intrappolate nei fanoni e inghiottite insieme al cibo esponendole a un grave rischio di inquinamento.",
            "whatYouCanDo": "Fare donazioni a delle associazioni serie come Greenpeace o la Shepherd. Parlare, documentarsi e condividere con altri la situazione dei cetacei. L'informazione aiuta a creare consapevolezza e questa genera rispetto e sensibilità.",
    ...
    val animal10 = """
        {
            ...
            "classification": "Mammifero",
            "averageLife": "20-30",
            "animalDescription": "Buffa e simpatica, è una delle specie di foca più rare e l’unica presente nel Mediterraneo. È considerata una delle 100 specie di mammiferi più minacciati al mondo. Può raggiungere i 2,5 metri di lunghezza e i 300 kg di peso. Il muso ha dei lunghi ciuffi di vibrisse. Osservazioni più o meno regolari avvengono ancora nei nostri mari, in Basilicata, in Sicilia e intorno alle isole del Tirreno.",
            "threats": "Nel Mediterraneo, è stata oggetto di costante ostilità da parte dell’uomo e in particolare dei pescatori che, in passato, vedevano in lei un acerrimo competitore. Ciò ha favorito l’attuale comportamento estremamente schivo e diffidente di questa specie.Un tempo veniva cacciata anche per le pelli e il grasso, che veniva trasformato in olio. In tutto il Mediterraneo è molto rara e in declino numerico anche a causa del disturbo da parte del turismo nei siti di riproduzione, soprattutto con le imbarcazioni da diporto.In alcune aree resta il problema della persecuzione con uccisione illegale e la cattura accidentale con le reti da pesca",
            "whatYouCanDo": "Diverse organizzazioni internazionali da anni si sono però attivate con campagne di sensibilizzazione per garantire la sopravvivenza degli ultimi animali ancora in vita. Nel 2019 l’Associazione europea per i mammiferi acquatici (Eaam) raddoppierà i suoi sforzi per aiutare questa specie attraverso l’organizzazione greca MOm, che salva e riabilita i cuccioli di foca monaca e poi li rimette in libertà. Mentre tutti gli sforzi stanno dando i risultati sperati, resta ancora molto lavoro da fare per essere davvero ottimisti sul pieno recupero della specie. Quest’anno Sea Shepherd Grecia e Sea Shepherd Italia per la prima volta uniranno le forze per lanciare la “Campagna Difesa Foca Monaca”, per difendere la foca monaca del Mediterraneo, Monachus monachus. La campagna è già iniziata in Grecia e sta per partire anche in Italia.",
